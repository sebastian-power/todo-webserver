...
Revision ID: 5dd9c5168e39
Revises: 
Create Date: 2024-01-27 15:36:40.082269
...
def upgrade():
    ...
    sa.Column('pfp_url', sa.String(length=48), nullable=False),
    ...
    sa.Column('helpers', sa.String(length=20), nullable=True),
